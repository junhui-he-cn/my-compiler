...
for direct and member calls while `len` keeps its legacy dedicated path; native
and collection/aggregate lowering beyond those records remains later M1C/M1D/M1E
slices.
